...
class catalog78989899(Resource):
	def patch(self , book_id):
		...
		if not result:
			...
			response = requests.put("http://192.168.1.50:8000/" + "consistant2", {"item_id" :book_id , "topic" : result.topic})
			response = requests.put("http://192.168.1.50:7000/" + "follow_up_buy", {"item_id" :book_id  ,"number_in_stock" : result.number_in_stock})
			response = requests.put("http://192.168.1.50:9000/" + "follow_up_buy", {"item_id" :book_id  ,"number_in_stock" : result.number_in_stock})
...
api.add_resource(catalog78989899, "/book3/<book_id>")
