...
class order3(Resource):
	...
	def put(self,book_id ):
		...
		if(temppp['exsist']==-1):
		    ...
		    response = requests.put("http://192.168.1.50:5000/" + "follow_up_order", {"item_id" : book_id , "date" : str(datetime.datetime.utcnow()) })
...
api.add_resource(front44888888, "/follow_up_order")  
